...
```{r, fig.cap = 'Figure 1. Items Frequency.'}
...
```{r, fig.cap = 'Figure 2. A graph showing the division into rules.'}
topRules<-rules#[1:10]
plot(topRules, method="graph", engine = "htmlwidget")
```


```{r, message = FALSE, warning = FALSE, fig.cap = 'Figure 3. The strength of the rule measured by a lift.'}
...
```{r, fig.cap = 'Figure 4. Grouped matrix for 7 rules.'}
...
```{r fig.cap = 'Figure 5. Graph for 2 rules.'}
...
```{r, fig.cap = 'Figure 6. Parallel coordinates plot for 2 rules.'}
